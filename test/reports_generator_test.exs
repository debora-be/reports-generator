defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    test "builds the report when a file list is provided" do
    ...
    test "when a file list is not provided, returns an error" do
      response = ReportsGenerator.build_from_many("any_thing")
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when the option is 'foods', returns the most reported food" do
      file_name = "report_test.csv"
    ...
    test "when an invalid option is given, returns an error" do
      ...
      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("any")
